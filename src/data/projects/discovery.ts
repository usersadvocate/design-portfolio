const discovery = {
  ...
  role: "I read the book “Continuous Discovery Habits” and came up with architectural solution that can be integrated into our interface. Additionally, I became part of a trio that was conducting interviews with users.",
  lessons:
